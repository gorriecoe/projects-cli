...
module.exports = function(args, callback, ee) {
  ...
  tasks = [
    getRepos,
    require('../tasks/preflight.js'),
    require('../tasks/projectname.js'),
    require('../tasks/selectinstaller.js'),
    require('../tasks/selectgroup.js'),
    require('../tasks/initRemoteRepo.js'),
    require('../tasks/setupFolder.js'),
    require('../tasks/runCommand.js'),
    require('../tasks/initRepo.js')
  ];
